...
from hcode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from hcode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from hcode.agents.trace import TraceManager, TraceNode
from hcode.agents.task_manager import BackgroundTask, TaskManager
from hcode.agents.notification import format_task_notification, inject_task_notifications
from hcode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".hcode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from hcode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from hcode.tools.agent_tool import AgentToolParams
