...
from hcode.client import needs_tool_search_beta
from hcode.conversation import Message, ToolResultBlock
from hcode.mcp.loading_strategy import (
    McpLoadingMode,
    apply_mode,
    decide_mode,
...
from hcode.mcp.tool_wrapper import build_mcp_tool_name, mcp_tool_name_prefix
from hcode.permissions.rules import extract_content
...
from hcode.tools.mcp_call import (
    McpCallParams,
    McpCallTool,
    coerce_by_schema,
    permission_content,
...
class TestLoadingStrategy:
    ...
    def test_env_override(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("HCODE_MCP_LOADING", "dispatch")
...
class TestPermissionContent:
    ...
    def test_rule_matches_by_server_glob(self) -> None:
        from hcode.permissions.rules import evaluate_rules, parse_rule
