...
PROJECT_AGENTS_DIR = ".hcode/agents"
USER_AGENTS_DIR = "~/.hcode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("hcode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from hcode.agents.parser import parse_frontmatter, _validate_agent_meta
