...
from hcode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from hcode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".hcode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".hcode", "memory")
    ...
    async def _do_consolidation(
        ...
        transcript_dir = os.path.join(self._work_dir, ".hcode", "sessions")
        ...
        checker = PermissionChecker(
            ...
            rule_engine=RuleEngine(
                ...
                project_rules_path=Path(self._work_dir) / ".hcode" / "permissions.yaml",
                local_rules_path=Path(self._work_dir) / ".hcode" / "permissions.local.yaml",
            ),
