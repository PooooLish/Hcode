...
from hcode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from hcode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from hcode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
