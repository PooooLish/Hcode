...
from hcode.teams.backend_detect import BackendDetectionError, detect_backend
from hcode.teams.mailbox import Mailbox, create_message
...
from hcode.teams.progress import TeammateProgress
from hcode.teams.registry import AgentNameRegistry
from hcode.teams.shared_task import SharedTaskStore
from hcode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from hcode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from hcode.teams.spawn_iterm2 import kill_pane
                kill_pane(pane_id)
