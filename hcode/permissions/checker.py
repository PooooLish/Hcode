...
from hcode.permissions.dangerous import DangerousCommandDetector, is_safe_command
from hcode.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from hcode.permissions.rules import Rule, RuleEngine, evaluate_rules, extract_content
from hcode.permissions.sandbox import PathSandbox
from hcode.tools.base import Tool
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".hcode/plans/" in target_path
        try:
