...
from hcode.mcp.loading_strategy import NATIVE_TOOL_SEARCH_BETA
from hcode.conversation_pairing import ensure_tool_pairing
from hcode.serialization import (
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .hcode/config.yaml or via ANTHROPIC_API_KEY env var."
            )
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .hcode/config.yaml or via OPENAI_API_KEY env var."
            )
        ...
        try:
            ...
            async for chunk in response:
                ...
                if not chunk.choices:
                    ...
                    if usage and not stream_end_emitted:
                        yield StreamEnd(
